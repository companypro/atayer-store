...
//   void dispose() {
//     super.dispose();
//     printerManager.stopScan(); // Stop scanning when disposing
//   }
//
//   void _scanDevices() {
...
//       final printer = await _selectedPrinter!.connect();
...
//     return Scaffold(
//       appBar: AppBar(title: Text('Print Invoice')),
//       body: ListView(
...
//                     selected: device == _selectedPrinter,
//                   );
//                 },
//               ),
//               SizedBox(height: 20.0),
//               ElevatedButton(
//                 onPressed: _selectedPrinter != null ? () => _printInvoice() : null,
...
//     // Implement your logic for generating invoice and printing
//     try {
//       final ByteData data = await rootBundle.load('assets/invoice_image.png');
//       final image = i.decodeImage(Uint8List.view(data.buffer));
//       await _printReceipt(image!);
//     } catch (e) {
//       developer.log('Error printing invoice: $e');
//     }
//   }
// }
//
